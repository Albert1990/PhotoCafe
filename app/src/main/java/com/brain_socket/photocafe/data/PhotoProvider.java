...
public class PhotoProvider
{
    ...
    {
        try {
            File cacheDir = PhotoCafeApp.getAppContext().getExternalCacheDir();
            if (cacheDir == null){//cache dir not available
                cacheDir = PhotoCafeApp.getAppContext().getCacheDir();
            }
            ...
            ImageLoaderConfiguration.Builder builder = new ImageLoaderConfiguration.Builder(PhotoCafeApp.getAppContext());
...
//			builder.memoryCache(new UsingFreqLimitedMemoryCache(2000000));
    ...
    private void checkLastCacheClearTimestamp()
    {
        try {
            ...
            long timenow = PhotoCafeApp.getTimestampNow();
            // compare times
